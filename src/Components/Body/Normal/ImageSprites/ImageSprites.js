...
const ImageSprites = () => {
    ...
    const [spritsHover, setSpritsHover] = useState(false)
    return (
        <Layout>
            <div className='name'>
                <h2>Image Sprites</h2>
            ...
            <section className="section">
                ...
                <div className="codeRunDiv">
                    ...
                    {
                        spritsHover ? <button className="seeCodeButton" onClick={() => setSpritsHover(!spritsHover)}>hide code</button> : <button className="seeCodeButton" onClick={() => setSpritsHover(!spritsHover)}>code</button>
                    }
                </div>

                
                {
                    spritsHover && <div className="codeDiv">
                    <code>
                        <span className='cssComment'>&#47;* css *&#47;</span><br />
                        <span className='seclector'>#yellowStar</span> &#123; <br />
                        &nbsp;&nbsp;<span className='cssName'>height</span>: <span className='cssTextvalue'>100px</span>;<br />
